...
lxc exec $ENVNAME --  apt-get update
lxc exec $ENVNAME --  apt-get install python3.11 -y
lxc exec $ENVNAME --  apt-get install python3.11-tk -y 

lxc exec $ENVNAME --  update-alternatives --install /usr/bin/python python /usr/bin/python3.11 1
